...
app.post("/generate-fir", async (req, res) => {
  try {
    ...
    const APPLICATION_PROMPT = `You are a legal assistant. Generate a formal complaint/application letter to the police.
...
* Include:
  ...
  • Request for action
  • Name, address placeholders if missing
* Maintain formal tone
* Do NOT generate FIR format
* Output plain clean text (no JSON, no markdown, no extra system lines)

OUTPUT RULES:
- Output exactly TWO blocks separated by the line: ===HINDI===
- First block = English Application. Second block = Hindi Application.
- HINDI RULES (for application_hindi): Translate ALL content into formal legal Hindi.
- The Application MUST end with a signature section. No text must appear after the signature.
- Do NOT include any of the following: "Electronically Generated Document", "Document Timestamp", Website links, or any footer indicating this was generated by software.`;
